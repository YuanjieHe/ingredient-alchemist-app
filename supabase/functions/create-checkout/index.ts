...
serve(async (req) => {
  ...
  try {
    ...
    const priceConfig = {
      ...
      seasonal: { amount: 1399, interval: "month", interval_count: 3 }, // $13.99/3个月
      annual: { amount: 4999, interval: "year" }, // $49.99/年
      lifetime: { amount: 7999, interval: null } // $79.99 一次性
    };
