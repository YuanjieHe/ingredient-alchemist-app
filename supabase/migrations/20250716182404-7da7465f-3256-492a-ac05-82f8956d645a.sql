...
-- Create policies for ingredients bank
CREATE POLICY "Users can view their own ingredients" 
ON public.ingredients_bank 
FOR SELECT 
USING (auth.uid() = user_id);
...
-- Create policies for recipes history
CREATE POLICY "Users can view their own recipes" 
ON public.recipes_history 
FOR SELECT 
USING (auth.uid() = user_id);
