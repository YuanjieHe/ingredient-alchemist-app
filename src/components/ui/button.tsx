  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        purple: "bg-gradient-primary text-white shadow-soft hover:shadow-medium hover:scale-[1.02]",
        accent: "bg-gradient-accent text-foreground shadow-soft hover:shadow-medium hover:scale-[1.02]",
        warm: "bg-gradient-accent text-foreground shadow-soft hover:shadow-medium hover:scale-[1.02]",
        fresh: "bg-gradient-secondary text-foreground shadow-soft hover:shadow-medium hover:scale-[1.02]",
      },
      size: {
