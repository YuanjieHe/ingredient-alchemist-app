...
const translations = {
  en: {
    ...
    backToGeneratedRecipes: 'Back to Generated Recipes',
    ...
    active: 'Active',
    expired: 'Expired',
    freeTrialProgress: 'Free Trial Progress',
    remainingGenerations: 'remaining free generations',
    generationsRemaining: 'remaining',
    usedGenerations: 'Used',
    totalGenerations: 'Total',
    freeTrialExhausted: 'Free trial exhausted, upgrade to premium for unlimited generations',
    ...
    restorePurchases: 'Restore Purchases (iOS)',
    premiumBenefits: 'Premium Benefits:',
    unlimitedRecipes: '• Unlimited recipe generation',
    smartPortioning: '• Smart dish portioning based on people count',
    completeMealPlans: '• Main + side dish complete combinations',
    prioritySupport: '• Priority customer support',
    activeUntil: 'Active until',
    loadSubscriptionFailed: 'Failed to load subscription info'
  },
  zh: {
    // App Title
    appTitle: 'SmartChef AI',
    ...
    backToGeneratedRecipes: '返回生成的菜谱',
    ...
    loadingSubscription: '加载中...',
    premiumMember: '高级会员',
    freeUser: '免费用户',
    status: '状态',
    active: '有效',
    expired: '已过期',
    freeTrialProgress: '免费试用进度',
    remainingGenerations: '次免费生成机会',
    generationsRemaining: '次剩余',
    usedGenerations: '已使用',
    totalGenerations: '总共',
    freeTrialExhausted: '免费次数已用完，升级到高级会员享受无限生成',
    upgradeToPremium: '升级到高级会员',
    monthly: '月付',
    quarterly: '季付',
    annual: '年付',
    lifetime: '终生会员',
    ...
    select: '选择',
    processing: '处理中...',
    restorePurchases: '恢复购买 (iOS)',
    premiumBenefits: '高级会员特权:',
    unlimitedRecipes: '• 无限次菜谱生成',
    smartPortioning: '• 根据人数智能搭配菜品',
    completeMealPlans: '• 主菜 + 配菜完整搭配',
